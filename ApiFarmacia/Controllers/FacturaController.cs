...
public class FacturaController : BaseController
{
    ...
    {
        var entity = await _unitOfWork.Facturas.GetAllAsync();
        return _mapper.Map<List<FacturaDto>>(entity);
    }
    [HttpPost]
    [ProducesResponseType(StatusCodes.Status200OK)]
    [ProducesResponseType(StatusCodes.Status400BadRequest)]
    public async Task<ActionResult<Factura>> Post(FacturaDto entityDto)
    {
        var entity = _mapper.Map<Factura>(entityDto);
    /*
    ...
    */
        _unitOfWork.Facturas.Add(entity);
    ...
    [ProducesResponseType(StatusCodes.Status404NotFound)]
    [ProducesResponseType(StatusCodes.Status400BadRequest)]
    public async Task<ActionResult<FacturaDto>> Put(int id, [FromBody] FacturaDto entityDto)
    {
        var entity = _mapper.Map<Factura>(entityDto);
        if (entity.Id == 0)
        {
    ...
    */
    ...
    public async Task<ActionResult> Delete(int id)
    {
        ...
        _unitOfWork.Facturas.Remove(entity);
        await _unitOfWork.SaveAsync();
        return NoContent();
    }
}
